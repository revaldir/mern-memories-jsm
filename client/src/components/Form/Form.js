        ...
        return (
            <Paper className={classes.paper}>
                <Typography variant="h6" align="center">
                    Please sign in first to create your own memories or like others memories.
                </Typography>
            </Paper>
        )
    }
    ...
    return (
        <Paper className={classes.paper}>
            <form autoComplete='off' noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <Button variant="contained" size="small" color="secondary" onClick={clearForm} fullWidth>Clear</Button>
            </form>
        </Paper>
    )
}
